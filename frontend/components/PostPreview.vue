		...
		<div class="w-full h-[24vh]  box-border my-[0.7rem] relative flex items-start inline-flex">
			...
			<div class=" w-3/4 bg-bgcolor">
				...
				<div class="w-full h-[7vh]  rounded-sm border-b border-terotory mx-2 flex">
					...
					<h1
						class="w-[8vw] h-[2vw] left-[20vw] mx-4 bg-purple-200 rounded absolute text-center text-neutral-900 text-[1.25vw] font-normal font-'Roboto'">
						網頁程式設計</h1>

					<img class=" w-[4vh] h-[4vh] mx-[1vw] " src="@/PostPreview/Thumb.png" />
