    ...
    <div class="scrollable-box">
      <div class="relative" style="height: 40vh; display: flex; align-items: center; justify-content: center;">
        ...
        <label for="locationInput" class="cursor-pointer" @click="showLocation"
          ...
          <div
            class="bg-purple-200 h-30 w-[20vw] rounded-full text-start text-neutral-900 text-s font-normal px-2 mt-14 ml-2">
            <p class=" text-black text-lg font-normal p-2">Search...</p>
          </div>
        </label>
      </div>
