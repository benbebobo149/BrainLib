<template>
  <div class="flex flex-col w-full h-[92vh] bg-white relative">
    <div class="flex w-full h-1/12 mt-10 items-start justify-center">
    ...
    <NuxtLink to="http://localhost:3000/activityCreate"  class="fixed bottom-4 right-4">
